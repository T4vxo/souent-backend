 ...
 */
exports.query = function (sql, args, opts) {
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            result = _db.query(sql, Array.isArray(args) ? args : [args], function (e, res) {
                if (!opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, mysql_1.default.createConnection(__assign({}, JSON.parse(fs_1.default.readFileSync('/var/cred/souentcred').toString()), { charset: "utf8_general_ci" }))];
                case 1:
                    _db = _a.sent();
                    _db.connect(function (e) {
                        if (e) {
